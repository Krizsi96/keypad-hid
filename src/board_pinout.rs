...
impl Board {
    pub fn new(peripherals: Peripherals) -> Self {
        Self {
            ...
            keypad_columns: [
                Output::new(peripherals.PA4, Level::Low, Speed::Low),
                Output::new(peripherals.PA5, Level::Low, Speed::Low),
                Output::new(peripherals.PC4, Level::Low, Speed::Low),
                Output::new(peripherals.PA7, Level::Low, Speed::Low),
            ],
        }
    }
}
